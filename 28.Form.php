...
<?php
    if ($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        if (!$conn){
            ...
            // Add a new trip to the Tip table in database
            if($result){
            ...
            <strong>Error!</strong>We are facing some technical issue and your entery was not submitted successfully!
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true">&times</span>
            </button>
            </div>';
...
<h1>Contact us for your concerns</h1>
    <form action="/php_code/28.Form.php" method="post">
