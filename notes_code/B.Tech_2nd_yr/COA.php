...
<body>
    ...
    <div class="main_content">
        ...
        <div class="info">
            <div class="sub_header"><h4>B.Tech > CSE > 1st Year >COA</h4></div>
            <div class="sub_blocks">
                <a href="/nh_project/notes_file/B.Tech_2nd_yr/COA/Unit-1A.pdf">Unit-1A</a>
                <a href="/nh_project/notes_file/B.Tech_2nd_yr/COA/Unit-1B.pdf">Unit-1B</a>
