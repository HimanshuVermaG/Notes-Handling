...
<tr id="lg-1">
<td class="tl-1"><div align="left" id="tb-name">College Name:</div></td>
<td class="tl-4"><?php echo $rows['collegename']; ?></td>
</tr>

<tr id="lg-1">
<td class="tl-1"><div align="left" id="tb-name">Course Name:</div></td>
<td class="tl-4"><?php echo $rows['coursename']; ?></td>
</tr>


<tr id="lg-1">
<td class="tl-1"><div align="left" id="tb-name">Branch:</div></td>
<td class="tl-4"><?php echo $rows['branchname']; ?></td>
</tr>

<tr id="lg-1">
<td class="tl-1"><div align="left" id="tb-name">Year:</div></td>
